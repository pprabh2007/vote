...
public class ContractorPortal extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contractor_portal);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(ContractorPortal.this, ViewNewsActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.contractor_portal, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings_voter) {
            Intent intent=new Intent(ContractorPortal.this, MyProfile.class);
            intent.putExtra("THIS_USER_OBJECT", THIS_USER_OBJECT);
            startActivityForResult(intent, REQUEST_CODE);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if(id==R.id.con_logout_nav_bar)
        {
            ...
            Intent intent=new Intent(ContractorPortal.this , MainActivity.class);
    ...
    public void onBackPressed()
    {
        if (back_pressed + 2000 > System.currentTimeMillis()) {
            startActivity(new Intent(ContractorPortal.this, MainActivity.class));
        }
